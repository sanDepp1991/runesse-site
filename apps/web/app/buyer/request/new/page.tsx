...
export default function NewRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // ✅ NEW: Delivery address required in Phase-1
    const cleanAddress = deliveryAddressText.trim();
    if (!cleanAddress) {
      ...
      <div className="grid gap-4 lg:grid-cols-[2fr,1.2fr]">
        ...
        <div className="rounded-2xl border border-neutral-800 bg-black/40 p-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-4 space-y-2 rounded-xl border border-neutral-800 bg-neutral-950/60 p-3">
              <h3 className="text-xs font-semibold text-neutral-200">
                Delivery address (Phase-1)
              </h3>
              <p className="text-[11px] text-neutral-500">
                This address will be shared with the cardholder only after they
                accept your request, and only while the request is active.
              </p>
