// apps/web/app/buyer/kyc/page.tsx
"use client";
...
const BuyerPanKycPage: React.FC = () => {
  ...
  // Load current PAN status for this logged-in user
  useEffect(() => {
    const loadStatus = async () => {
      try {
        ...
        const res = await fetch("/api/kyc/pan/status?role=BUYER", {
          cache: "no-store",
          headers: token
            ? {
        ...
        console.error("Buyer PAN status error", err);
      } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Buyer PAN verify error", err);
      setStatus("FAILED");
...
export default BuyerPanKycPage;
