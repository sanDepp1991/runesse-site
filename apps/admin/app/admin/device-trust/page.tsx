    ...
    <div className="min-h-screen bg-black text-neutral-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full border border-neutral-800 rounded-2xl p-6 bg-neutral-900/60 shadow-lg">
        ...
        <button
          ...
          className="w-full rounded-xl border border-emerald-500/60 bg-emerald-500/20 px-4 py-2 text-sm font-medium text-emerald-100 hover:bg-emerald-500/30 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
