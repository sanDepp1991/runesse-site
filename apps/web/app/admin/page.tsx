...
function statusSubtitle(status: RequestStatus) {
  const s = (status || "PENDING").toUpperCase();
  if (s === "PENDING") {
    return "Waiting for a cardholder to accept and buyer/cardholder proofs.";
  }
  if (s === "MATCHED") {
    return "Cardholder has accepted; waiting for proofs and admin action.";
  }
  if (s === "COMPLETED") {
        ...
        return (
          ...
          >
            ...
            <div className="mt-1.5 flex justify-between text-[11px] text-neutral-500">
              ...
              <span>{statusSubtitle(req.status as RequestStatus)}</span>
            </div>
          </Link>
        );
      })}
              ...
              <div className="mb-2 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-neutral-500">
                    Waiting for cardholder matching / proofs
                  </p>
                </div>
            ...
            <section className="flex flex-col rounded-2xl border border-neutral-900 bg-neutral-950/80 p-3">
              <div className="mb-2 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-neutral-500">
                    Cardholder has accepted; admin verification pending
                  </p>
                </div>
                <span className="rounded-full bg-neutral-900 px-2 py-0.5 text-[10px] text-neutral-400 border border-neutral-800">
                  {matched.length}
              ...
              <AdminRequestsList
                items={matched}
                emptyTitle="No matched trades."
                emptySubtitle="Once cardholders accept, trades move here."
              />
            </section>
            ...
            <section className="flex flex-col rounded-2xl border border-neutral-900 bg-neutral-950/80 p-3">
              <div className="mb-2 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-neutral-500">
                    Requests already closed in the system.
                  </p>
                </div>
                <span className="rounded-full bg-neutral-900 px-2 py-0.5 text-[10px] text-neutral-400 border border-neutral-800">
                  {completed.length}
